...
import (
	...
	"github.com/lyyyuna/gococo/pkg/log" // lyyyuna
	// "cmd/internal/edit"
	// "cmd/internal/objabi"
)
...
func Annotate(name string, varVar string, globalCoverVarImportpath string) string {
	// lyyyuna
	counterStmt = atomicCounterStmt
	...
	file := &File{
		...
		name:    name,
		content: content,
		edit:    NewBuffer(content), // lyyyuna
		astFile: parsedFile,
		varVar:  varVar, // lyyyuna
	}
	...
	if bytes.Equal(content, newContent) {
		...
		// lyyyuna: add global cover variables import path
